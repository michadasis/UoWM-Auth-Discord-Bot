...
const messages = {
    ...
    wrong_department: {
        ...
        text: 'Ο server απευθύνεται σε φοιτητές του Τμήματος Πληροφορικής (λογαριασμοί της μορφής `cs01234`). Αν πιστεύετε ότι πρόκειται για λάθος, επικοινωνήστε με τους διαχειριστές.',
    },
    not_eligible: {
        tone: 'error',
    ...
    not_in_guild: {
        tone: 'error',
        title: 'Δεν είστε μέλος του server',
        text: 'Μπείτε πρώτα στον Discord server «Πληροφορική UoWM» και δοκιμάστε ξανά.',
    },
    resend_too_soon: {
        tone: 'warning',
