    ...
    run: async ({ interaction, client }) => {
        ...
        try {
            ...
            await target.send({ embeds: [new EmbedBuilder()
                ...
                .setDescription('Οι διαχειριστές του server «Πληροφορική UoWM» αφαίρεσαν την επιβεβαίωση του λογαριασμού σας και τα σχετικά δεδομένα διαγράφηκαν. Μπορείτε να επιβεβαιωθείτε ξανά με την εντολή `/auth` ή να επικοινωνήσετε με τους διαχειριστές.')] }).catch(() => {});
